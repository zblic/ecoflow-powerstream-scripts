...
for a particular purpose, safety, reliability, compatibility, and
non-infringement.
...
electrical problems, financial loss, or any other consequences arising from the
use or misuse of this software.

Use this software at your own risk. You are responsible for understanding what
the scripts do before running them, and for complying with all applicable laws,
regulations, electrical safety requirements, grid operator rules, and device
warranty terms.
...
EcoFlow, ioBroker, or the authors of the ioBroker EcoFlow MQTT adapter.
EcoFlow and PowerStream are trademarks of their respective owners.
